...
public class Controller
{
    ...
    public static bool SaveBarcode(BarcodeSettings barcode)
    {
        IsError = false;
    ...
    public static BarcodeSettings GetBarcode(Symbologies type, string data, string fileType, double scale)
    {
        var code = new BarcodeSettings();
        code.Data = data;
